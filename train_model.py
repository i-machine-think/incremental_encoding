...
from incremental import AnticipatingEncoderRNN, IncrementalSeq2Seq, AnticipatingEmbeddingEncoderRNN, AnticipatingDecoderRNN
...
if opt.load_checkpoint is not None:
    ...
    decoder = decoder_cls(len(tgt.vocab), max_len, decoder_hidden_size,
...
if opt.anticipation_loss == "normal":
    ...
    losses.append(anticipation_loss)
